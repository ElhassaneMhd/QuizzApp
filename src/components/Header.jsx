        ...
        <header className="flex justify-between items-center  py-2 mx-2  md:mx-10 ">
            ...
            <div className="flex items-center">
                ...
                <span className='group relative px-2 cursor-pointer text-text '>
                        <Link  to={'/settings'} className='px-2 text-text flex items-center gap-1 rounded-full m-[1px] hover:bg-light hover:scale-105' ><i className="text-3xl fa-solid fa-gear"></i></Link>
